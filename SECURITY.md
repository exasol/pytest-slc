...
* Please create a draft security advisory on the GitHub page: the reporting form is under `> Security > Advisories`. The URL is https://github.com/exasol/pytest-slc/security/advisories/new.
