...
* Please create a draft security advisory on the GitHub page: the reporting form is under `> Security > Advisories`. The URL is https://github.com/exasol/python-slc/security/advisories/new.
