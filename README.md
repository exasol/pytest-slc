...
The `pytest-exasol-slc` plugin provides pytest fixtures for building and uploading a script language container
...
The language container will be activated with the value returned by the fixture `language_alias`.
